...
- Текущий JSON-контекст приоритетнее истории. Если в старых сообщениях есть точный пробег,
  не повторяйте его: используйте только текущее округлённое значение из JSON.
